...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "˹ѕᴄαꝛ ꭙ мυѕιᴄ˼")
OWNER_ID = list(map(int, getenv("OWNER_ID", "6627636245").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Sashikanta85949/gadanayakop")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/STATUSDAIRY2")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/VOICEOFHEART0")
...
STATS_IMG_URL = "https://te.legra.ph/file/25efe6aa029c6baea73ea.jpg"
...
STREAM_IMG_URL = "https://te.legra.ph/file/25efe6aa029c6baea73ea.jpg"
